    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ localized_route('two-factor.login') }}" x-data="{ recovery: false }" novalidate>
            ...
            <div class="field" x-show="! recovery">
                ...
                <x-hearth-input id="code" type="text" name="code" inputmode="numeric" required autofocus autocomplete="one-time-code" />
            </div>
            ...
            <div class="field" x-show="recovery">
                ...
                <x-hearth-input id="recovery_code" type="text" name="recovery_code" autocomplete="one-time-code" />
            </div>
